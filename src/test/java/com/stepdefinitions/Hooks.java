...
/**
 * @author Rupak Mansingh cucumber hooks class helps in setting up before scenario
...
public class Hooks {
    ...
    /**
     * @param scenario take screenshot in case of failed scenario and embeded to
